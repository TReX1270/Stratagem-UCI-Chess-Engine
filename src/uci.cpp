...
void UciLoop(char** argv) {
    ...
    // print engine info
    std::cout << "> Stratagem started successfully. Enter '\033[38;5;129muci\033[0m' to get started...\n";
    ...
    while (true) {
        ...
        // parse UCI "uci" command
            ...
            // print engine info
            std::cout << "id name Stratagem 0.8\n";
            std::cout << "id author yanpuri\n";
            std::cout << "option name Hash type spin default 16 min 1 max 8192 \n";
            std::cout << "option name Threads type spin default 3 min 1 max 256 \n";
        ...
        // parse UCI "uci" command
            ...
            int score = nnue.output(td->pos.accumulator, stm);

            std::string score_color = Pick_color(score);
            std::string color_reset = "\033[0m";

            printf("Evaluation of this position according to the neural network is: %s%d%s\n",
                   score_color.c_str(), score, color_reset.c_str());
